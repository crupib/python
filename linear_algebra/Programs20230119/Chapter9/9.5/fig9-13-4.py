...
C.stroke(path.line(d, 0, d, d))
C.stroke(path.line(d, d, 0, d))
C.stroke(path.line(0, d, 0, 0))
C.stroke(path.line(0, d, d, 0))
C.stroke(path.line(0, 0, d, d))
