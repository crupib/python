...
words = '''
ant baboon badger bat bear beaver camel cat clam cobra cougar coyote crow deer dog donkey duck eagle ferret
...
def getGuess(alreadyGuessed):
    #  Return ns the letter the player entered. This function makes
